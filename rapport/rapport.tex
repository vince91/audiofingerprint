...
\section{Méthode par spectrogramme}
...
\subsubsection{Construction de la base de données}
...
\subsubsection{Efficacité de la méthode par spectrogramme}
...
La dernière expérimentation consiste à tester la robustesse de la méthode Shazam face au bruit. Pour chaque musique de la bibliothèque musicale, on extrait 10 seconde auxquelles on ajoute un bruit blanc en faisant varier $\sigma$. Ces extraits sont testés sur la base de données n°2.

\begin{figure}[htbp]
    \center
    \includegraphics[width=13cm]{shazam6.png}
    \caption{Robustesse de la méthode Shazam face au bruit blanc}
    \label{test3shaz}
\end{figure}
