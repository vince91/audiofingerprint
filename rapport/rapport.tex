...
locaux. Chaque paire clé-valeur de la table sera construite comme ceci : on sélectionne deux valeurs
...
On construit alors les histogrammes $\mathbf{H}_k(\tau) \, : \, \mathbb{Z} \rightarrow \mathbb{N}$ qui
contienent pour chaque indice $k \in [0,\dots,L-1]$ le nombre de clés ayant un décalage $\tau$.
